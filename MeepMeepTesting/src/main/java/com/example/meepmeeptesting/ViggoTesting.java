...
public class ViggoTesting {
    ...
    public static class AutoConstants {
        ...
        public static Pose2d BUCKET_ZONE = new Pose2d(60.5, 61.8, toRadians(180));
        ...
        public static final Supplier<Trajectory> START_TO_BZONE = () ->
                func.apply(START).lineToLinearHeading(BUCKET_ZONE).build();
    ...
    private static TrajectorySequence getTestTrajectory(DriveShim drive) {
        return drive
            ...
            .addTrajectory(AutoConstants.START_TO_BZONE.get())
            .build();
    }
}
